...
HEADERS      		:= food_wastage_tracker_backend.h food_wastage_tracker.h food_wastage_report.h food_wastage_record.h
# Space-separated list of implementation files (e.g., algebra.cpp)
IMPLEMS       		:= food_wastage_tracker_backend.cc food_wastage_tracker.cc food_wastage_report.cc food_wastage_record.cc
