...
TEST(FoodWastageTrackerBackend, AddDefaultRecord) {
...
TEST(FoodWastageTrackerBackend, AddMultipleBasicRecords) {
  FoodWastageTrackerBackend backend{""};
...
TEST(FoodWastageTrackerBackend, AddDuplicateRecord) {
  FoodWastageTrackerBackend backend{""};
...
TEST(FoodWastageTrackerBackend, AddManyRecords) {
  FoodWastageTrackerBackend backend{""};
